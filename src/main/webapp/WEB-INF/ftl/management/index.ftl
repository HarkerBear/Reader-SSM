...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <!--系统标题-->
        <div class="layui-logo" style="font-size:18px">Book Management</div>
        <!--右侧当前用户信息-->
        <ul class="layui-nav layui-layout-right">
            ...
            <!--注销按钮-->
            <li class="layui-nav-item"><a href="/management/logout">Sign Out</a></li>
        </ul>
    </div>
    <!--左侧菜单栏-->
            ...
            <ul class="layui-nav layui-nav-tree">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child module" data-node-id="xxx">
                            <dd><a href="/management/book/index.html" target="ifmMain">Book Management</a></dd>
